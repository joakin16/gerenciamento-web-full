...
function App() {
  ...
  return (
    <div>
      ...
      <a>
        <img src="https://youxgroup.com.br/wp-content/uploads/2021/07/logosite.png"></img>
      </a>

      <h1 style={{ textAlign: "center" }}>Lista de Funcionários</h1>

      {/* div Botão e input de pesquisa */}
      ...
      <div>
        <TextField 
          ...
          label="Nome"
        />
          <Button size="" variant="contained" startIcon={<SearchIcon/>} onClick={pesquisar}>Pesquisar</Button>
          ...
          <TableBody>
            {funcionarios.map((funcionario, index) => (
              <TableRow
                ...
                style={{
                  backgroundColor: index % 2 === 0 ? "#af9b98": "white",
                }}
              >
