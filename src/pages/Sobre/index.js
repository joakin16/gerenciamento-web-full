...
function Home() {
  ...
  const [indexPesquisa, setIndexPesquisaAux] = useState([]);
  ...
  function pesquisar() {
    let indexPesquisaAux = [];
    let indexPesquisaDeleteAux = [];
    const funcionariosAux = funcionarios;
    ...
    setIndexPesquisaAux(indexPesquisaAux);
    setIndexPesquisaDelete(indexPesquisaDeleteAux);
    console.log(indexPesquisa);
    console.log(indexPesquisaDelete);

    // for (let i = indexPesquisaDelete.length - 1; i >= 0; i--) {
    //   funcionariosAux.splice(indexPesquisaDelete[i], 1);
    // }
  }
