...
function Home() {
  const [funcionarios, setFuncionarios] = useState([
    ...
    },
    {
      nome: "Rakan",
      funcao: "Analista",
      habilidades: ["React Native", "React", "Java"],
      ...
      <ThemeProvider theme={theme}>
        ...
        <div className="pesquisarCadastrar">
          <TextField
            ...
            type="text"
            label="Pesquisar: Nome, Função, Habilidades, Preferencias"
            style={{ width: "420px" }}
          />
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            ...
            <TableBody stripedRows>
              ...
              {funcionarios.map((funcionario, index) =>
                // {Operador ternário para pesquisa}

                funcionario.nome
                  .toLowerCase()
                  .includes(inputPesquisa.toLowerCase()) ||
                funcionario.funcao
                  .toLowerCase()
                  .includes(inputPesquisa.toLowerCase()) ||
                funcionario.habilidades.some((habilidade) =>
                  habilidade.toLowerCase().includes(inputPesquisa.toLowerCase())
                ) ||
